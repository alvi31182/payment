 ...
 */
final class Version20240206200044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account_profile (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
